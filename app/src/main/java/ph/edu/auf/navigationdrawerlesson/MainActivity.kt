...
import ph.edu.auf.navigationdrawerlesson.fragments.FavoriteQuotesFragment
...
class MainActivity : AppCompatActivity(),
    ...
    FavoriteQuotesFragment.OnOpenDrawerListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_quotes_day, R.id.nav_love_quotes, R.id.nav_fave_quotes, R.id.nav_inspiring_quotes, R.id.nav_motivational_quotes, R.id.nav_fave_quotes
            ), drawerLayout
        )
